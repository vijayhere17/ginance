...
class StakeController extends Controller
{
    ...
    public function buyRobo()
    {
        ...
        return view('users.buy-bot')->with(['page_titel'=>$page_titel, 'coin_rate'=>$coin_rate, 'packages'=>$packages, 'usdt_con_addr'=>$usdt_con_addr, 'usdt_con_abi'=>$usdt_con_abi, "to_address"=>$to_address])->toJS();
    }
    ...
    public function setStakeActivation($member_id, $kit_id, $amount, $s_r_id)
    {
        ...
        $roiService = app(\App\Services\ROIService::class);

$roiService->createInvestment($log->id);
